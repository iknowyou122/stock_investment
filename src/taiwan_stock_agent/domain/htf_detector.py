...
class HTFDetector:
    ...
    def score(self, history: list[DailyOHLCV]) -> dict | None:
        ...
        # 2. Consolidation tightness (0–20 pts)
        ...
        # 4. Position in flag — near flag top = breakout imminent (0–15 pts)
        ...
        # 6. Prior advance speed (0–10 pts)
        if advance_bars <= 15:
            score += 10
