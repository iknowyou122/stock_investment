...
{{
  "narrative": "用 1-2 句話描述今日市場主軸，提到 2-3 個關鍵題材，說明資金往哪輪動",
  "dominant_themes": ["最熱的 3 個概念或產業，由強到弱"],
  "avoid_themes": ["建議避開的 2-3 個題材"],
  "rotation_call": "預測下一輪可能轉強的題材，格式：'A → B → C'",
...
注意：
- narrative 要具體、可操作，避免「市場震盪、看法分歧」這種廢話
