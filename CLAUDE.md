...
| Phase 4.40 | ✅ Done | **統一掃描輸出**：PullbackDetector（MA20回調型偵測）✅ · signal_type/horizon 欄位（蓄積/回調/爆量/趨勢延伸）✅ · `make plan` 整合 TCE + Pullback + Surge DB 三路信號 ✅ · 成長股基本面★標記（所有信號類型）✅ · 終端輸出新增 型態/持倉/基本面 欄位 ✅ · HTML 信號類型徽章 ✅ · 626 unit tests passing ✅ |
