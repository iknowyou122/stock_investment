...
# Skip all tests in this module — v1 scoring is superseded by v2.
# Point values, thresholds, and factor names changed in v2.
# See test_triple_confirmation_engine_v2.py for current coverage.
pytestmark = pytest.mark.skip(
    reason="v1 scoring superseded by v2 — see test_triple_confirmation_engine_v2.py"
)
